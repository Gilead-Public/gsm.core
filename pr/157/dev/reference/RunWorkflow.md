...
#> [INFO] SQL Query complete: 740 rows returned.
#> [INFO] Disconnected from temporary DuckDB connection.
#> [INFO] 740x15 data.frame saved as `lData$Mapped_SUBJ`.
#> [INFO] Returning results from final step: 740x15 data.frame`.
...
#> [INFO] 740x6 data.frame saved as `lData$Analysis_Input`.
...
#> ℹ 24 Group(s) have insufficient sample size due to KRI denominator less than 30: 0X1365, 0X2834, 0X3923, 0X6937, 0X3584, 0X5232, 0X3311, 0X3341, 0X3796, 0X4641, 0X6269, 0X8001, 0X3516, 0X376, 0X5374, 0X4477, 0X1758, 0X666, 0X3243, 0X4527, 0X5174, 0X9410, 0X6716, 0X1594
