...
- **Devin Pastoor**. Author.

- **Nathan Kosiba**. Author.

- **Douglas Sanders**. Author.

- **Li Ge**. Author.

- **Zhongkai Wang**. Author. [](https://orcid.org/0000-0002-1883-2265)

- **Colleen McLaughlin**. Author.

- **Chelsea Dickens**. Author.
...
Source:
[`DESCRIPTION`](https://github.com/Gilead-BioStats/gsm.core/blob/fix-107/DESCRIPTION)
...
Wang Z, McLaughlin C, Dickens C, Gans M (2025). *gsm.core: Good
Statistical Monitoring*. R package version 1.1.6,
