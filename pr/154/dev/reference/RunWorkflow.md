...
#> ✔ SQL Query complete: 762 rows returned.
#> Disconnected from temporary DuckDB connection.
#> 
#> ── 762x15 data.frame saved as `lData$Mapped_SUBJ`. 
#> 
#> ── Returning results from final step: 762x15 data.frame`. ──
#> 
...
#> 
#> ── 762x6 data.frame saved as `lData$Analysis_Input`. 
#> 
