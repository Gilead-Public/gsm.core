...
- [`Analyze_NormalApprox_PredictBounds()`](https://gilead-public.github.io/gsm.core/dev/reference/Analyze_NormalApprox_PredictBounds.md)
  **\[stable\]** : Funnel Plot Analysis with Normal Approximation -
  Predicted Boundaries.
- [`Analyze_Poisson_PredictBounds()`](https://gilead-public.github.io/gsm.core/dev/reference/Analyze_Poisson_PredictBounds.md)
...
- [`CheckSpec()`](https://gilead-public.github.io/gsm.core/dev/reference/CheckSpec.md)
  **\[stable\]** : Check if the data and spec are compatible
- [`GetLogAppender()`](https://gilead-public.github.io/gsm.core/dev/reference/GetLogAppender.md)
  : Get the current log appender function
- [`GetLogLevel()`](https://gilead-public.github.io/gsm.core/dev/reference/GetLogLevel.md)
  : Get the current logging threshold level
- [`GetStrFunctionIfNamespaced()`](https://gilead-public.github.io/gsm.core/dev/reference/GetStrFunctionIfNamespaced.md)
...
- [`ParseThreshold()`](https://gilead-public.github.io/gsm.core/dev/reference/ParseThreshold.md)
...
- [`SetLogAppender()`](https://gilead-public.github.io/gsm.core/dev/reference/SetLogAppender.md)
  : Set the active log appender
- [`SetLogLevel()`](https://gilead-public.github.io/gsm.core/dev/reference/SetLogLevel.md)
  : Set the active log level
- [`stop_if()`](https://gilead-public.github.io/gsm.core/dev/reference/stop_if.md)
...
- [`analyticsInput`](https://gilead-public.github.io/gsm.core/dev/reference/analyticsInput.md)
  **\[stable\]** : analyticsInput Dataset
- [`analyticsSummary`](https://gilead-public.github.io/gsm.core/dev/reference/analyticsSummary.md)
  **\[stable\]** : analyticsSummary Dataset
- [`reportingBounds`](https://gilead-public.github.io/gsm.core/dev/reference/reportingBounds.md)
  **\[stable\]** : reportingBounds Dataset
- [`reportingGroups`](https://gilead-public.github.io/gsm.core/dev/reference/reportingGroups.md)
  **\[stable\]** : reportingGroups Dataset
- [`reportingMetrics`](https://gilead-public.github.io/gsm.core/dev/reference/reportingMetrics.md)
...
- [`reportingActionLog`](https://gilead-public.github.io/gsm.core/dev/reference/reportingActionLog.md)
  : reportingActionLog Dataset
- [`reportingBounds_country`](https://gilead-public.github.io/gsm.core/dev/reference/reportingBounds_country.md)
  **\[stable\]** : reportingBounds_country Dataset
- [`reportingGroups_country`](https://gilead-public.github.io/gsm.core/dev/reference/reportingGroups_country.md)
  **\[stable\]** : reportingGroups_country Dataset
- [`reportingMetrics_country`](https://gilead-public.github.io/gsm.core/dev/reference/reportingMetrics_country.md)
  **\[stable\]** : reportingMetrics_country Dataset
- [`reportingResults_country`](https://gilead-public.github.io/gsm.core/dev/reference/reportingResults_country.md)
  **\[stable\]** : reportingResults_country Dataset
- [`reportingBounds_study`](https://gilead-public.github.io/gsm.core/dev/reference/reportingBounds_study.md)
  **\[stable\]** : reportingBounds_study Dataset
- [`reportingGroups_study`](https://gilead-public.github.io/gsm.core/dev/reference/reportingGroups_study.md)
  **\[stable\]** : reportingGroups_study Dataset
- [`reportingMetrics_study`](https://gilead-public.github.io/gsm.core/dev/reference/reportingMetrics_study.md)
  **\[stable\]** : reportingMetrics_study Dataset
- [`reportingResults_study`](https://gilead-public.github.io/gsm.core/dev/reference/reportingResults_study.md)
  **\[stable\]** : reportingResults_study Dataset
- [`lSource`](https://gilead-public.github.io/gsm.core/dev/reference/lSource.md)
