...
::: {.columns}
::: {.column width="65%"}
![](yaml1.png){fig-alt="Workflow yaml configuration example 1"}
:::

::: {.column width="35%"}
![](yaml2.png){fig-alt="Workflow yaml configuration example 2"}
:::
:::
...
![](data_model_detailed.png){fig-alt="Detailed {gsm} data model"}
...
![](report-cross-study-kri-report.png){fig-alt="Cross-Study KRI Report screenshot"}
...
![](report-country-kri-report.png){fig-alt="Country KRI Report screenshot"}
...
![](report-eligibility-report.png){fig-alt="Eligibility Report screenshot"}
...
![](report-site-kri-report.png){fig-alt="Site KRI Report screenshot"}
...
![](report-qtl-report.png){fig-alt="QTL Report screenshot"}
...
![](report-gsm-deep-dive-app.png){fig-alt="{gsm} Deep Dive App screenshot"}
