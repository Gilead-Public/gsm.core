...
- [`GetLogAppender()`](https://gilead-biostats.github.io/gsm.core/reference/GetLogAppender.md)
  : Get the current log appender function
- [`GetLogLevel()`](https://gilead-biostats.github.io/gsm.core/reference/GetLogLevel.md)
...
- [`SetLogAppender()`](https://gilead-biostats.github.io/gsm.core/reference/SetLogAppender.md)
  : Set the active log appender
- [`SetLogLevel()`](https://gilead-biostats.github.io/gsm.core/reference/SetLogLevel.md)
